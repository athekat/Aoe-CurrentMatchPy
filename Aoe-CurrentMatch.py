...
civilizations_file = "civilizationsnew.json"
...
if match_info:
  print(f"\n==========================\nDate: {started_formatted} \nMap: {match_info['mapName']}")
  print(f"==========================\n\n Player 1")
  print(f"{match_info['player1Name']} ({match_info['player1Rating']}) - {match_info['player1CivName']} \n {match_info['player1CivDescription']}\n")
  print(f"==========================\n\n Player 2")
  print(f"{match_info['player2Name']} ({match_info['player2Rating']}) - {match_info['player2CivName']} \n {match_info['player2CivDescription']}\n")
